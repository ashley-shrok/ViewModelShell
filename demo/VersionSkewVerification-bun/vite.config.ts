...
//
// NOTE: this page loads default.css via runtime <link> served verbatim from
// the framework by server.ts, so the human sign-off is against the *shipped*
// renderer AND the *shipped* CSS.
