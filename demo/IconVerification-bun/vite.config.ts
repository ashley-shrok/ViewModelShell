...
// -Verification-bun demo's vite.config.ts uses. Use REGEX keys, never string
// keys: a string "viewmodel-shell" prefix-matches "viewmodel-shell/browser"
// and silently breaks the subpath import (see AGENTS.md "Critical gotchas" #3).
//
