...
//
// NOTE: this page loads default.css + a picked theme via runtime <link> tags in
// index.html (served verbatim from the framework by server.ts), NOT via CSS
// imports here — so the human sign-off is against the *shipped* renderer AND
// the *shipped* CSS, and the theme is runtime-swappable (across 13 themes)
// without a rebuild.
