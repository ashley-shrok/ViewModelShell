...
- [x] **AGNOSTIC-04**: AGENTS.md and README updated to document the capability-seam pattern and the CI-enforced "core references zero platform globals" invariant (ships with the phase, not after)
