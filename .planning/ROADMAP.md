...
- [ ] **Phase 3: Default Design System** - Shipped stylesheet delivers page shell, spacing/type scale, density knob, card section variant — zero app CSS, override seam unchanged
