...
- [x] 33-02-PLAN.md — Old wire removal (8 fields from index.ts + ViewModels.cs) + TUI comment-out + tui-filter-refresh bounty + TS demo migration (Showcase, HelpDesk-bun, FeatureProbe-bun) (wave 2)
- [x] 33-03-PLAN.md — .NET demo migration: HelpDesk AgentController + tests, ExpenseTracker tests, FeatureProbe controller (wave 2, parallel with 33-02)
