...
Plans:
- [ ] 24-01-PLAN.md — ListRowNode (COMP-05) + ListNode.variant:"rows" (COMP-05a) end-to-end (wave 1)
...
- [ ] 24-05-PLAN.md — design/composite-nodes-layer.md Shipped Recipe Inventory + AGENTS.md Currently shipped recipes (wave 1, file-disjoint)
- [ ] 24-06-PLAN.md — Showcase Primary Composites section (wave 5, depends on 24-04)
