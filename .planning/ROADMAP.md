...
**Plans**: 3 plans
- [ ] 14-01-PLAN.md — `ActionEvent.blocking` + two-lane dispatch loop (mutex replacement, coalescing, epoch) in `index.ts` + full `browser.ts` propagation fix + vitest coverage for NBA-01/02/03 (wave 1)
