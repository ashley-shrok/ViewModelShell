...
- [ ] 18-05-PLAN.md — Parity: reshape FeatureProbe chart fixture (multi-series+tone+stacked) both backends + agent-skill.md reconcile/byte-copy; parity green (wave 2)
- [ ] 18-06-PLAN.md — Full green-tree gate + CHARTBASE-01..06 requirement-to-artifact cross-check (wave 3)
